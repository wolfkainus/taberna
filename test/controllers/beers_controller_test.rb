...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { price: @beer.price, reviews: @beer.reviews, trademark: @beer.trademark, type: @beer.type }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { price: @beer.price, reviews: @beer.reviews, trademark: @beer.trademark, type: @beer.type }
    assert_redirected_to beer_path(assigns(:beer))
  end
